...
- Include the appropriate SPDX header for new files (project default licensing is BUSL-1.1; see `LICENSE` and `COMMERCIAL_LICENSE.md`).
...
- By contributing, you agree your code is licensed under this repository's terms (BUSL-1.1 with Additional Use Grant, as documented in `LICENSE`).
...
- Report bugs or request features via [GitHub Issues](https://github.com/jblanc86-maker/blanc-quant-lob-engine/issues).
...
- Treat all contributors with respect and keep review feedback constructive and specific.
