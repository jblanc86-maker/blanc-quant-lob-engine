...
| `determinism_compiler_matrix.yml` | *(final job stdout)* | Markdown digest table in Step Summary |
...
| Kernel-version replay not tested | `determinism_affinity_kernel.yml` + this doc §4 | ✅ Closed |
